...
@patch('mysql.connector.connect')
def test_get_code_entry(mock_connect, mock_db_config, mock_code_entry, mock_cursor, mock_conn):
...
@patch('mysql.connector.connect')
def test_create_package_entry(mock_connect, mock_db_config, mock_code_entry, mock_cursor, mock_conn):
...
@patch('mysql.connector.connect')
def test_delete_package_and_cleanup(mock_connect, mock_db_config, mock_cursor, mock_conn):
